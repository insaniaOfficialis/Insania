...
public class BiographyHeroes : Reestr
{
    /// <summary>
    /// Ссылка на персонажа
    /// </summary>
    ...
    public BiographyHeroes(string user, bool isSystem, Hero hero, int dayBegin,
        Month monthBegin, int cycleBegin, int? dayEnd, Month? monthEnd, int? cycleEnd,
        string text) : base(user, isSystem)
    {
        HeroId = hero.Id;
        Hero = hero;
        DayBegin = dayBegin;
    ...
    /// <param name="cycleEnd">Цикл окончания</param>
    /// <param name="text">Текст</param>
    public BiographyHeroes(long id, string user, bool isSystem, Hero hero, int dayBegin,
        Month monthBegin, int cycleBegin, int? dayEnd, Month? monthEnd, int? cycleEnd,
        string text) : base(id, user, isSystem)
    {
        HeroId = hero.Id;
        Hero = hero;
        DayBegin = dayBegin;
