...
public class BiographyRequestHeroRegistration : Reestr
{
    ...
    /// </summary>
    public BiographyHeroes Biography { get; private set; }
    ...
    public BiographyRequestHeroRegistration(string user, bool isSystem,
        RequestHeroRegistration request, BiographyHeroes biography) : base(user, isSystem)
    {
    ...
    /// <param name="request">Ссылка на заявку</param>
    /// <param name="biography">Ссылка на биографию</param>
    public BiographyRequestHeroRegistration(long id, string user, bool isSystem,
        RequestHeroRegistration request, BiographyHeroes biography) : base(id, user, isSystem)
    {
        RequestId = request.Id;
        Request = request;
        BiographyId = biography.Id;
    ...
    /// </summary>
    /// <param name="biography">Ссылка на биографию</param>
    public void SetBiography(BiographyHeroes biography)
    {
        BiographyId = biography.Id;
        Biography = biography;
    }
