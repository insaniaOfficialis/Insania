...
public class RequestHeroRegistration : Reestr
{
    ...
    public bool? EyeColorDecision { get; private set; }
    ...
    public string? CommentOnEyeColor { get; private set; }
    ...
    public RequestHeroRegistration(string user, bool isSystem, Hero hero,
        StatusRequestsHeroRegistration status) : base(user, isSystem)
    {
        HeroId = hero.Id;
        Hero = hero;
        StatusId = status.Id;
    ...
    public RequestHeroRegistration(long id, string user, bool isSystem, Hero hero,
        StatusRequestsHeroRegistration status) : base(id, user, isSystem)
    {
        HeroId = hero.Id;
        Hero = hero;
        StatusId = status.Id;
    ...
    /// <param name="comentOnEyeColor">Комментарий к цвету глаз</param>
    public void SetEyeColor(bool eyeColorDecision, string? comentOnEyeColor)
    {
        EyeColorDecision = eyeColorDecision;
        CommentOnEyeColor = comentOnEyeColor;
    }
