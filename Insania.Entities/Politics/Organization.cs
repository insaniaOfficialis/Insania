...
public class Organization : Reestr
{
    ...
    public Organization(string user, bool isSystem, string name, TypeOrganization type,
        Organization parent) : base(user, isSystem)
    {
        Name = name;
        TypeId = type.Id;
        Type = type;
    ...
    /// <param name="type">Ссылка на тип</param>
    /// <param name="parent">Ссылка на родителя</param>
    public Organization(long id, string user, bool isSystem, string name,
        TypeOrganization type, Organization parent) : base(id, user, isSystem)
    {
        Name = name;
        TypeId = type.Id;
        Type = type;
