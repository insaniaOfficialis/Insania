...
namespace Insania.Entities.Politics;
...
public class Country : Reestr
{
    ...
    public Country(string user, bool isSystem, string name, string numberOnMap,
        string colorOnMap, string languageForNames, Organization organization) : base(user,
        isSystem)
    {
        Name = name;
    ...
    /// <param name="languageForNames">Язык для названий</param>
    /// <param name="organization">Ссылка на организацию</param>
    public Country(long id, string user, bool isSystem, string name, string numberOnMap,
        string colorOnMap, string languageForNames, Organization organization) : base(id,
        user, isSystem)
    {
        Name = name;
        NumberOnMap = numberOnMap;
