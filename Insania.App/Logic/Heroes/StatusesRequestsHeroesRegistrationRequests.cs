...
/// <summary>
/// Запросы работы со статусами заявок на регистрацию персонажей
/// </summary>
/// <param name="configuration">Интерфейс конфигурации</param>
public class StatusesRequestsHeroesRegistrationRequests(IConfiguration configuration) : IStatusesRequestsHeroesRegistration
{
    /// <summary>
    ...
    /// <summary>
    /// Метод получения списка статусов заявок на регистрацию персонажа по id
    /// </summary>
