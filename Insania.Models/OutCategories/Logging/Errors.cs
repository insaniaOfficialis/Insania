...
public static class Errors
{
    ...
    public const string EmtryDecision = "Пустое решение";
    ...
    public const string EmptyServiceBiographiesHeroes = "Пустой сервис работы с биографиями персонажей";
    public const string EmptyServiceBiographiesRequestsHeroesRegistration = "Пустой сервис работы с биографиями заяок на регистрацию персонажей";
    ...
    public const string EmptyUrlBiographiesHeroes = "Пустая ссылка работы с биографиями персонажей";
    public const string EmptyUrlBiographiesReguestsHeroesRegistration = "Пустая ссылка работы с биографиями заявок на регистрацию персонажей";
