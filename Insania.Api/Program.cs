...
services.AddScoped<IAuthenticationService, AuthenticationService>(); //аутентифкаци€
services.AddScoped<IUsersService, UsersService>(); //сервис работы с пользовател€ми
