...
//”станавливаем игнорирование типов даты и времени
...
services.AddScoped<IAuthentication, AuthenticationService>(); //аутентифкаци€
services.AddScoped<IUsers, UsersService>(); //сервис работы с пользовател€ми
services.AddScoped<IRaces, RacesService>(); //сервис работы с расами
services.AddScoped<INations, NationsService>(); //сервис работы с наци€ми
services.AddScoped<IMonths, MonthsService>(); //сервис работы с мес€цами
...
services.AddScoped<IAreas, AreasService>(); //сервис работы с област€ми
...
services.AddScoped<IPrefixesNames, PrefixesNamesService>(); //сервис работы с префиксами имЄн
services.AddScoped<IParameters, ParametersService>(); //сервис работы с префиксами имЄн
...
services.AddScoped<IRequestsHeroesRegistration, ReuestsHeroRegistration>(); //сервис работы с за€вками на регистрацию персонажей
