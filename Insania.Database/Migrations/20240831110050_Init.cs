...
namespace Insania.Database.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "dir_sections_information_articles",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "Первичный ключ таблицы")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dir_sections_information_articles", x => x.id);
                    table.ForeignKey(
                        name: "FK_dir_sections_information_articles_dir_sections_information_~",
                        column: x => x.parent_id,
                        principalTable: "dir_sections_information_articles",
                        principalColumn: "id");
                },
                comment: "Разделы информационных статей");

            migrationBuilder.CreateTable(
                name: "dir_statuses_feedback",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "Первичный ключ таблицы")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dir_statuses_feedback", x => x.id);
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dir_types_feedback", x => x.id);
                    table.ForeignKey(
                        name: "FK_dir_types_feedback_dir_types_feedback_parent_id",
                        column: x => x.parent_id,
                        principalTable: "dir_types_feedback",
                        principalColumn: "id");
                },
            ...
            migrationBuilder.CreateTable(
                name: "re_headers_information_articles",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "Первичный ключ таблицы")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    name = table.Column<string>(type: "text", nullable: false, comment: "Наименование"),
                    sequence_number = table.Column<int>(type: "integer", nullable: true, comment: "Порядковый номер"),
                    section_id = table.Column<long>(type: "bigint", nullable: false, comment: "Ссылка на раздел"),
                    date_create = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "Дата создания"),
                    user_create = table.Column<string>(type: "text", nullable: false, comment: "Пользователь, создавший"),
                    date_update = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "Дата обновления"),
                    user_update = table.Column<string>(type: "text", nullable: false, comment: "Пользователь, обновивший"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_re_headers_information_articles", x => x.id);
                    table.ForeignKey(
                        name: "FK_re_headers_information_articles_dir_sections_information_ar~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    author_id = table.Column<long>(type: "bigint", nullable: true, comment: "Ссылка на автора"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_re_feedback", x => x.id);
                    table.ForeignKey(
                        name: "FK_re_feedback_dir_statuses_feedback_status_id",
                        column: x => x.status_id,
                        principalTable: "dir_statuses_feedback",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_re_feedback_dir_types_feedback_type_id",
                        column: x => x.type_id,
                        principalTable: "dir_types_feedback",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_re_feedback_sys_users_author_id",
            ...
            migrationBuilder.CreateTable(
                name: "re_details_information_articles",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "Первичный ключ таблицы")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    title = table.Column<string>(type: "text", nullable: false, comment: "Оглавление"),
                    text = table.Column<string>(type: "text", nullable: false, comment: "Текст"),
                    sequence_number = table.Column<int>(type: "integer", nullable: true, comment: "Порядковый номер"),
                    header_id = table.Column<long>(type: "bigint", nullable: false, comment: "Ссылка на оглавление"),
                    date_create = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "Дата создания"),
                    user_create = table.Column<string>(type: "text", nullable: false, comment: "Пользователь, создавший"),
                    date_update = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "Дата обновления"),
                    user_update = table.Column<string>(type: "text", nullable: false, comment: "Пользователь, обновивший"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_re_details_information_articles", x => x.id);
                    table.ForeignKey(
                        name: "FK_re_details_information_articles_re_headers_information_arti~",
                        column: x => x.header_id,
                        principalTable: "re_headers_information_articles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                },
            ...
            migrationBuilder.CreateTable(
                name: "un_files_details_information_articleses",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "Первичный ключ таблицы")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    detail_information_article_id = table.Column<long>(type: "bigint", nullable: false, comment: "Ссылка на детальную часть информационной статьи"),
                    date_create = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "Дата создания"),
                    user_create = table.Column<string>(type: "text", nullable: false, comment: "Пользователь, создавший"),
                    date_update = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "Дата обновления"),
                    user_update = table.Column<string>(type: "text", nullable: false, comment: "Пользователь, обновивший"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_un_files_details_information_articleses", x => x.id);
                    table.ForeignKey(
                        name: "FK_un_files_details_information_articleses_re_details_informat~",
                        column: x => x.detail_information_article_id,
                        principalTable: "re_details_information_articles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_un_files_details_information_articleses_re_files_file_id",
                        column: x => x.file_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dir_sections_information_articles_alias",
                table: "dir_sections_information_articles",
                column: "alias",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_dir_sections_information_articles_parent_id",
                table: "dir_sections_information_articles",
                column: "parent_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dir_types_feedback_parent_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_re_details_information_articles_header_id",
                table: "re_details_information_articles",
                column: "header_id");

            migrationBuilder.CreateIndex(
                name: "IX_re_feedback_author_id",
                table: "re_feedback",
                column: "author_id");

            migrationBuilder.CreateIndex(
                name: "IX_re_feedback_status_id",
                table: "re_feedback",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_re_feedback_type_id",
                table: "re_feedback",
                column: "type_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_re_headers_information_articles_section_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_un_files_details_information_articleses_detail_information_~",
                table: "un_files_details_information_articleses",
                column: "detail_information_article_id");

            migrationBuilder.CreateIndex(
                name: "IX_un_files_details_information_articleses_file_id_detail_info~",
                table: "un_files_details_information_articleses",
                columns: ["file_id", "detail_information_article_id"],
                unique: true);
